...
pub const SPHERE_VERTICES: &[Vertex] = &[
    // Interior
    Vertex { position: [0.00, -1.00, 0.00], color: [0.20, 0.80, 0.80], normal: [0.00, -1.00, 0.00] },
    // Strip 1 from bottom
    Vertex { position: [0.50, -0.87, 0.00], color: [0.20, 0.80, 0.80], normal: [0.50, -0.87, 0.00] },
    Vertex { position: [0.43, -0.87, 0.25], color: [0.20, 0.80, 0.80], normal: [0.43, -0.87, 0.25] },
    Vertex { position: [0.25, -0.87, 0.43], color: [0.20, 0.80, 0.80], normal: [0.25, -0.87, 0.43] },
    Vertex { position: [0.00, -0.87, 0.50], color: [0.20, 0.80, 0.80], normal: [0.00, -0.87, 0.50] },
    Vertex { position: [-0.25, -0.87, 0.43], color: [0.20, 0.80, 0.80], normal: [-0.25, -0.87, 0.43] },
    Vertex { position: [-0.43, -0.87, 0.25], color: [0.20, 0.80, 0.80], normal: [-0.43, -0.87, 0.25] },
    Vertex { position: [-0.50, -0.87, 0.00], color: [0.20, 0.80, 0.80], normal: [-0.50, -0.87, 0.00] },
    Vertex { position: [-0.43, -0.87, -0.25], color: [0.20, 0.80, 0.80], normal: [-0.43, -0.87, -0.25] },
    ...
    Vertex { position: [0.43, -0.87, -0.25], color: [0.20, 0.80, 0.80], normal: [0.43, -0.87, -0.25] },
    // Strip 2 from bottom
    Vertex { position: [0.87, -0.50, 0.00], color: [0.20, 0.80, 0.80], normal: [0.87, -0.50, 0.00] },
    Vertex { position: [0.75, -0.50, 0.43], color: [0.20, 0.80, 0.80], normal: [0.75, -0.50, 0.43] },
    Vertex { position: [0.43, -0.50, 0.75], color: [0.20, 0.80, 0.80], normal: [0.43, -0.50, 0.75] },
    Vertex { position: [0.00, -0.50, 0.87], color: [0.20, 0.80, 0.80], normal: [0.00, -0.50, 0.87] },
    Vertex { position: [-0.43, -0.50, 0.75], color: [0.20, 0.80, 0.80], normal: [-0.43, -0.50, 0.75] },
    Vertex { position: [-0.75, -0.50, 0.43], color: [0.20, 0.80, 0.80], normal: [-0.75, -0.50, 0.43] },
    Vertex { position: [-0.87, -0.50, 0.00], color: [0.20, 0.80, 0.80], normal: [-0.87, -0.50, 0.00] },
    Vertex { position: [-0.75, -0.50, -0.43], color: [0.20, 0.80, 0.80], normal: [-0.75, -0.50, -0.43] },
    ...
    Vertex { position: [0.75, -0.50, -0.43], color: [0.20, 0.80, 0.80], normal: [0.75, -0.50, -0.43] },
    // Strip 3 from bottom
    Vertex { position: [1.00, 0.00, 0.00], color: [0.20, 0.80, 0.80], normal: [1.00, 0.00, 0.00] },
    Vertex { position: [0.87, 0.00, 0.50], color: [0.20, 0.80, 0.80], normal: [0.87, 0.00, 0.50] },
    Vertex { position: [0.50, 0.00, 0.87], color: [0.20, 0.80, 0.80], normal: [0.50, 0.00, 0.87] },
    Vertex { position: [0.00, 0.00, 1.00], color: [0.20, 0.80, 0.80], normal: [0.00, 0.00, 1.00] },
    Vertex { position: [-0.50, 0.00, 0.87], color: [0.20, 0.80, 0.80], normal: [-0.50, 0.00, 0.87] },
    Vertex { position: [-0.87, 0.00, 0.50], color: [0.20, 0.80, 0.80], normal: [-0.87, 0.00, 0.50] },
    Vertex { position: [-1.00, 0.00, 0.00], color: [0.20, 0.80, 0.80], normal: [-1.00, 0.00, 0.00] },
    Vertex { position: [-0.87, 0.00, -0.50], color: [0.20, 0.80, 0.80], normal: [-0.87, 0.00, -0.50] },
    ...
    // Inverted hull
    Vertex { position: [0.00, -1.07, 0.00], color: [0.00, 0.00, 0.00], normal: [0.00, -1.07, 0.00] },
    // Strip 1 from bottom
    Vertex { position: [0.53, -0.93, 0.00], color: [0.00, 0.00, 0.00], normal: [0.53, -0.93, 0.00] },
    Vertex { position: [0.46, -0.93, 0.27], color: [0.00, 0.00, 0.00], normal: [0.46, -0.93, 0.27] },
    Vertex { position: [0.27, -0.93, 0.46], color: [0.00, 0.00, 0.00], normal: [0.27, -0.93, 0.46] },
    Vertex { position: [0.00, -0.93, 0.53], color: [0.00, 0.00, 0.00], normal: [0.00, -0.93, 0.53] },
    Vertex { position: [-0.27, -0.93, 0.46], color: [0.00, 0.00, 0.00], normal: [-0.27, -0.93, 0.46] },
    Vertex { position: [-0.46, -0.93, 0.27], color: [0.00, 0.00, 0.00], normal: [-0.46, -0.93, 0.27] },
    Vertex { position: [-0.53, -0.93, 0.00], color: [0.00, 0.00, 0.00], normal: [-0.53, -0.93, 0.00] },
    Vertex { position: [-0.46, -0.93, -0.27], color: [0.00, 0.00, 0.00], normal: [-0.46, -0.93, -0.27] },
    ...
    Vertex { position: [0.46, -0.93, -0.27], color: [0.00, 0.00, 0.00], normal: [0.46, -0.93, -0.27] },
    // Strip 2 from bottom
    Vertex { position: [0.93, -0.54, 0.00], color: [0.00, 0.00, 0.00], normal: [0.93, -0.54, 0.00] },
    Vertex { position: [0.80, -0.54, 0.46], color: [0.00, 0.00, 0.00], normal: [0.80, -0.54, 0.46] },
    Vertex { position: [0.46, -0.54, 0.80], color: [0.00, 0.00, 0.00], normal: [0.46, -0.54, 0.80] },
    Vertex { position: [0.00, -0.54, 0.93], color: [0.00, 0.00, 0.00], normal: [0.00, -0.54, 0.93] },
    Vertex { position: [-0.46, -0.54, 0.80], color: [0.00, 0.00, 0.00], normal: [-0.46, -0.54, 0.80] },
    Vertex { position: [-0.80, -0.54, 0.46], color: [0.00, 0.00, 0.00], normal: [-0.80, -0.54, 0.46] },
    Vertex { position: [-0.93, -0.54, 0.00], color: [0.00, 0.00, 0.00], normal: [-0.93, -0.54, 0.00] },
    Vertex { position: [-0.80, -0.54, -0.46], color: [0.00, 0.00, 0.00], normal: [-0.80, -0.54, -0.46] },
    ...
    Vertex { position: [0.80, -0.54, -0.46], color: [0.00, 0.00, 0.00], normal: [0.80, -0.54, -0.46] },
    // Strip 3 from bottom
    Vertex { position: [1.07, 0.00, 0.00], color: [0.00, 0.00, 0.00], normal: [1.07, 0.00, 0.00] },
    Vertex { position: [0.93, 0.00, 0.53], color: [0.00, 0.00, 0.00], normal: [0.93, 0.00, 0.53] },
    Vertex { position: [0.54, 0.00, 0.93], color: [0.00, 0.00, 0.00], normal: [0.54, 0.00, 0.93] },
    Vertex { position: [0.00, 0.00, 1.07], color: [0.00, 0.00, 0.00], normal: [0.00, 0.00, 1.07] },
    Vertex { position: [-0.53, 0.00, 0.93], color: [0.00, 0.00, 0.00], normal: [-0.53, 0.00, 0.93] },
    Vertex { position: [-0.93, 0.00, 0.54], color: [0.00, 0.00, 0.00], normal: [-0.93, 0.00, 0.54] },
    Vertex { position: [-1.07, 0.00, 0.00], color: [0.00, 0.00, 0.00], normal: [-1.07, 0.00, 0.00] },
    Vertex { position: [-0.93, 0.00, -0.53], color: [0.00, 0.00, 0.00], normal: [-0.93, 0.00, -0.53] },
    Vertex { position: [-0.54, 0.00, -0.93], color: [0.00, 0.00, 0.00], normal: [-0.54, 0.00, -0.93] },
    Vertex { position: [-0.00, 0.00, -1.07], color: [0.00, 0.00, 0.00], normal: [-0.00, 0.00, -1.07] },
    ...
    Vertex { position: [0.93, 0.00, -0.54], color: [0.00, 0.00, 0.00], normal: [0.93, 0.00, -0.54] },
    // Strip 4 from bottom
    Vertex { position: [0.93, 0.53, 0.00], color: [0.00, 0.00, 0.00], normal: [0.93, 0.53, 0.00] },
    Vertex { position: [0.80, 0.53, 0.46], color: [0.00, 0.00, 0.00], normal: [0.80, 0.53, 0.46] },
    Vertex { position: [0.46, 0.53, 0.80], color: [0.00, 0.00, 0.00], normal: [0.46, 0.53, 0.80] },
    Vertex { position: [0.00, 0.53, 0.93], color: [0.00, 0.00, 0.00], normal: [0.00, 0.53, 0.93] },
    Vertex { position: [-0.46, 0.53, 0.80], color: [0.00, 0.00, 0.00], normal: [-0.46, 0.53, 0.80] },
    Vertex { position: [-0.80, 0.53, 0.46], color: [0.00, 0.00, 0.00], normal: [-0.80, 0.53, 0.46] },
    Vertex { position: [-0.93, 0.53, 0.00], color: [0.00, 0.00, 0.00], normal: [-0.93, 0.53, 0.00] },
    Vertex { position: [-0.80, 0.53, -0.46], color: [0.00, 0.00, 0.00], normal: [-0.80, 0.53, -0.46] },
    ...
    Vertex { position: [0.80, 0.53, -0.46], color: [0.00, 0.00, 0.00], normal: [0.80, 0.53, -0.46] },
    // Strip 5 from bottom
    Vertex { position: [0.54, 0.93, 0.00], color: [0.00, 0.00, 0.00], normal: [0.54, 0.93, 0.00] },
    Vertex { position: [0.46, 0.93, 0.27], color: [0.00, 0.00, 0.00], normal: [0.46, 0.93, 0.27] },
    Vertex { position: [0.27, 0.93, 0.46], color: [0.00, 0.00, 0.00], normal: [0.27, 0.93, 0.46] },
    Vertex { position: [0.00, 0.93, 0.54], color: [0.00, 0.00, 0.00], normal: [0.00, 0.93, 0.54] },
    Vertex { position: [-0.27, 0.93, 0.46], color: [0.00, 0.00, 0.00], normal: [-0.27, 0.93, 0.46] },
    Vertex { position: [-0.46, 0.93, 0.27], color: [0.00, 0.00, 0.00], normal: [-0.46, 0.93, 0.27] },
    Vertex { position: [-0.54, 0.93, 0.00], color: [0.00, 0.00, 0.00], normal: [-0.54, 0.93, 0.00] },
    Vertex { position: [-0.46, 0.93, -0.27], color: [0.00, 0.00, 0.00], normal: [-0.46, 0.93, -0.27] },
