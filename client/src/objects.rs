...
pub const SPHERE_VERTICES: &[Vertex] = &[
    ...
    // Inverted hull
    Vertex { position: [0.00, -1.02, 0.00], color: [0.00, 0.00, 0.00], normal: [0.00, -1.02, 0.00] },
    // Strip 1 from bottom
    Vertex { position: [0.51, -0.88, 0.00], color: [0.00, 0.00, 0.00], normal: [0.51, -0.88, 0.00] },
    Vertex { position: [0.44, -0.88, 0.25], color: [0.00, 0.00, 0.00], normal: [0.44, -0.88, 0.25] },
    Vertex { position: [0.26, -0.88, 0.44], color: [0.00, 0.00, 0.00], normal: [0.26, -0.88, 0.44] },
    Vertex { position: [0.00, -0.88, 0.51], color: [0.00, 0.00, 0.00], normal: [0.00, -0.88, 0.51] },
    Vertex { position: [-0.25, -0.88, 0.44], color: [0.00, 0.00, 0.00], normal: [-0.25, -0.88, 0.44] },
    Vertex { position: [-0.44, -0.88, 0.26], color: [0.00, 0.00, 0.00], normal: [-0.44, -0.88, 0.26] },
    Vertex { position: [-0.51, -0.88, 0.00], color: [0.00, 0.00, 0.00], normal: [-0.51, -0.88, 0.00] },
    Vertex { position: [-0.44, -0.88, -0.25], color: [0.00, 0.00, 0.00], normal: [-0.44, -0.88, -0.25] },
    Vertex { position: [-0.26, -0.88, -0.44], color: [0.00, 0.00, 0.00], normal: [-0.26, -0.88, -0.44] },
    Vertex { position: [-0.00, -0.88, -0.51], color: [0.00, 0.00, 0.00], normal: [-0.00, -0.88, -0.51] },
    ...
    Vertex { position: [0.44, -0.88, -0.26], color: [0.00, 0.00, 0.00], normal: [0.44, -0.88, -0.26] },
    // Strip 2 from bottom
    Vertex { position: [0.88, -0.51, 0.00], color: [0.00, 0.00, 0.00], normal: [0.88, -0.51, 0.00] },
    Vertex { position: [0.77, -0.51, 0.44], color: [0.00, 0.00, 0.00], normal: [0.77, -0.51, 0.44] },
    Vertex { position: [0.44, -0.51, 0.76], color: [0.00, 0.00, 0.00], normal: [0.44, -0.51, 0.76] },
    Vertex { position: [0.00, -0.51, 0.88], color: [0.00, 0.00, 0.00], normal: [0.00, -0.51, 0.88] },
    Vertex { position: [-0.44, -0.51, 0.77], color: [0.00, 0.00, 0.00], normal: [-0.44, -0.51, 0.77] },
    Vertex { position: [-0.76, -0.51, 0.44], color: [0.00, 0.00, 0.00], normal: [-0.76, -0.51, 0.44] },
    Vertex { position: [-0.88, -0.51, 0.00], color: [0.00, 0.00, 0.00], normal: [-0.88, -0.51, 0.00] },
    Vertex { position: [-0.77, -0.51, -0.44], color: [0.00, 0.00, 0.00], normal: [-0.77, -0.51, -0.44] },
    Vertex { position: [-0.44, -0.51, -0.76], color: [0.00, 0.00, 0.00], normal: [-0.44, -0.51, -0.76] },
    Vertex { position: [-0.00, -0.51, -0.88], color: [0.00, 0.00, 0.00], normal: [-0.00, -0.51, -0.88] },
    ...
    Vertex { position: [0.76, -0.51, -0.44], color: [0.00, 0.00, 0.00], normal: [0.76, -0.51, -0.44] },
    // Strip 3 from bottom
    Vertex { position: [1.02, 0.00, 0.00], color: [0.00, 0.00, 0.00], normal: [1.02, 0.00, 0.00] },
    Vertex { position: [0.88, 0.00, 0.51], color: [0.00, 0.00, 0.00], normal: [0.88, 0.00, 0.51] },
    Vertex { position: [0.51, 0.00, 0.88], color: [0.00, 0.00, 0.00], normal: [0.51, 0.00, 0.88] },
    Vertex { position: [0.00, 0.00, 1.02], color: [0.00, 0.00, 0.00], normal: [0.00, 0.00, 1.02] },
    Vertex { position: [-0.51, 0.00, 0.88], color: [0.00, 0.00, 0.00], normal: [-0.51, 0.00, 0.88] },
    Vertex { position: [-0.88, 0.00, 0.51], color: [0.00, 0.00, 0.00], normal: [-0.88, 0.00, 0.51] },
    Vertex { position: [-1.02, 0.00, 0.00], color: [0.00, 0.00, 0.00], normal: [-1.02, 0.00, 0.00] },
    Vertex { position: [-0.88, 0.00, -0.51], color: [0.00, 0.00, 0.00], normal: [-0.88, 0.00, -0.51] },
